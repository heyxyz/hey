  ...
  return (
    <Card className="p-5 space-y-3">
      <div className="flex items-center space-x-3">
        ...
        />
        <button
          className="w-full flex items-center dark:text-gray-400 space-x-2 bg-gray-100 dark:bg-gray-900 px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700"
          type="button"
