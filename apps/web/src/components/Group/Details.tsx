...
const Details: FC<DetailsProps> = ({ group }) => {
  ...
  return (
    <div className="mb-4 space-y-5 px-5 sm:px-0">
      <div className="size-32 sm:size-52 relative">
        <Image
          alt={group.slug}
          className="size-32 sm:size-52 cursor-pointer rounded-xl bg-gray-200 ring-8 ring-gray-50 dark:bg-gray-700 dark:ring-black"
          height={128}
