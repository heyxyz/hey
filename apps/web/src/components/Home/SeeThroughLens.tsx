...
const SeeThroughLens: FC = () => {
  ...
  return (
    <DropdownMenu.Root modal={false}>
      ...
      <DropdownMenu.Content className="menu-transition absolute right-0 z-[5] mt-1 w-64 rounded-xl border bg-white shadow-sm focus:outline-none dark:border-gray-700 dark:bg-gray-900">
