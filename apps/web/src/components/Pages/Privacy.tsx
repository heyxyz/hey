          ...
          <div className="max-w-3/4 relative mx-auto rounded-lg sm:w-2/4">
            <div className="lt-text-gray-500 max-w-none !p-8">
              ...
              <div className="space-y-5 leading-7">
                <p>
                  <Trans>
                    ...
                    agreements for using the Site. And you agree to our
                    collection and use of any personal data (as described here)
                    as well as the features of public/permissionless blockchain
                    technology.
                  </Trans>
                </p>
                <p>
                ...
                <p>
                  <Trans>
                    By accessing or using the Site, you accept and assume
                    certain inherent features related to engaging in recording
                    the data on the blockchain. Interactions with the Lens
                    Protocol rely on smart contracts stored on a publicly
                    available blockchain, cryptographic tokens generated by the
                    smart contracts, and other nascent software, applications
                    and systems that interact with blockchain-based networks.
                    One of the defining features of blockchain technology is
                    that its entries are immutable, which means, as a technical
                    matter, they generally cannot be deleted or modified by
                    anyone. If you are not comfortable assuming the inherently
                    immutable and public nature of all entries on the
              ...
              <div className="space-y-5 leading-7">
                ...
                <p>
                  <Trans>
                    You may choose to voluntarily provide other information to
                    us that we have not solicited from you, and, in such
                ...
                <ul className="list-inside list-disc space-y-3">
                  <li>
                    <Trans>
                      <b>Log Files</b>, to record events or errors that occur
                      when using our Site.
                    </Trans>
                  </li>
                  <li>
                  ...
                  <li>
                    <Trans>
                      ...
                      publicly visible and/or accessible on blockchains. This
              ...
              <p className="leading-7">
                <Trans>
                  We may need to use it to operate and manage the Services on
                  this Site (or other places), provide you support, ensure we
                  comply with laws and regulation, and enforce the security of
              ...
              <p className="leading-7">
                <Trans>
                  This Privacy Policy does not apply to websites, apps,
                  products, or services that we do not own or control. For
                  example, your interactions with Ethereum wallet are governed
                  by the applicable privacy policies of that particular wallet.
                </Trans>
              </p>
              ...
              <div className="space-y-5 leading-7">
                ...
                <p>
                  <Trans>
                    We may change to other third-party analytics service
                    provider. The Privacy Policy of Analytics subjects to the
                    every provider. You should review everything before using
                    the Site.
                  </Trans>
                </p>
              </div>
              ...
              <div className="space-y-5 leading-7">
                ...
                <ul className="list-inside list-disc space-y-2">
                  <li>
                    <Trans>
                      <b>Cookies</b>. We will only use strictly necessary
                      cookies. These cookies are essential for you to browse the
                      Site and use its features, including accessing secure
                      areas of the Site.
                    </Trans>
                  </li>
                  <li className="linkify">
                    <Trans>
                      <b>Do Not Track</b>. Your browser settings may allow you
                      to automatically transmit a “Do Not Track” signal to the
                      online services you visit. Note, however, there is no
                      industry consensus as to what Site and app operators
                      should do with regard to these signals. Accordingly,
                      unless and until the law is interpreted to require us to
              ...
              <p className="leading-7">
                <Trans>
                  The Site is intended for general audiences and are not
                  directed at children. To use the Site, you must legally be
              ...
              <p className="leading-7">
                <Trans>
                  ...
                  of doubt, your continued use of the Site indicates your
