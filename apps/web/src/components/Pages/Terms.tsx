...
const Terms: FC = () => {
  useEffectOnce(() => {
    PostHog.track(PAGEVIEW, { page: 'terms' });
  });
          ...
          <div className="max-w-3/4 relative mx-auto rounded-lg sm:w-2/4">
            <div className="lt-text-gray-500 max-w-none !p-8">
              ...
              <div className="space-y-5 leading-7">
                ...
                <p>
                  <Trans>
                    ...
                    Agreement applies to all users of the Site, including
                    without limitation users who are browsers, builders, and/or
                ...
                <p>
                  <Trans>
                    ...
                    version of the Terms at any time on this page. We reserve
                    the right to update, change or replace any part of these
                    Terms by posting updates and/or changes to our Site. It is
                    your responsibility to check this page periodically for
                    changes. Your continued use of or access to the Site
              ...
              <p className="leading-7">
                <Trans>
                  You may not use our Site for any illegal or unauthorised
                  purpose nor may you, in the use of the Service, violate any
                  laws in your jurisdiction (including but not limited to
                  copyright laws). We reserve the right to refuse the services
                  to anyone for any reason at any time. We may stop (permanently
                  or temporarily) providing the services or any features within
                  the Site to you or to users generally.
                </Trans>
              </p>
              ...
              <div className="space-y-5 leading-7">
                <p>
                  <Trans>
                    User Lens profile is referred as the “Profile” in the
                    “Site”.
                  </Trans>
                </p>
                <p>
                ...
                <p>
                  <Trans>
                    If you’re not comfortable with interacting with an
                    inherently transparent blockchain, you should not engage
                    with our Site to create and manage a content on the Lens
                    Protocol. You are solely responsible for the safekeeping of
                    the private key associated with the blockchain address used
                    to interact with the Lens Protocol.
                  </Trans>{' '}
                  <b>
                    <Trans>
                      The transactions on blockchain including transfer of
                      tokens and data attached to it are permanent and cannot be
                      undone.
                    </Trans>
                  </b>
                </p>
                <p>
                  <Trans>
                    ...
                    hosted on a third-party provider IPFS and Arweave. We are
                    not responsible for any action or omission taken by
                    IPFS/Arweave as it pertains to the user interface or
                ...
                <p>
                  <Trans>
                    ...
                    and we are not responsible for the operation of such
                    networks.
                  </Trans>
                </p>
              </div>
              ...
              <div className="space-y-5 leading-7">
                <p>
                  <Trans>
                    ...
                    apps like Discord, or MetaMask, and we make no
                ...
                <p>
                  <Trans>
                    ...
                    practices and make sure you understand them before you
                    engage in any transaction. Complaints, claims, concerns, or
                    questions regarding third-party products should be directed
                    to the third-party.
                  </Trans>
                </p>
              </div>
              ...
              <div className="space-y-5 leading-7">
                ...
                <ul className="list-inside list-disc space-y-2">
                  <li>
                    <Trans>
                      for any unlawful purpose and to solicit others to perform
                  ...
                  <li>
                    <Trans>
                      ...
                      circumvent the security features of the Site or any
                      related website, other websites, or the Internet. We
                      reserve the right to terminate your use of the Site or any
              ...
              <p className="leading-7">
                <Trans>
                  ...
                  wallet. We may restrict your access to the Site for any
                  reason, including, but not limited, compliance with sanctions
                  regulations.
                </Trans>
              </p>
              ...
              <p className="leading-7">
                <Trans>
                  ...
                  function differently than you expected. You agree to accept
                  the Site as is. You expressly agree that your use of, or
                  inability to use, the Site is at your sole risk. Our liability
                  shall be limited entirely or to the maximum extent permitted
                  by law.
                </Trans>
              </p>
              ...
              <div className="space-y-5 leading-7">
                ...
                <p>
                  <Trans>
                    ...
                    reserve the right to terminate our Agreement with you and
