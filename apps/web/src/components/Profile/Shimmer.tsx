      ...
      <GridLayout className="pt-6">
        <GridItemFour>
          <div className="mb-4 space-y-9 px-5 sm:px-0">
            <div className="size-32 sm:size-52 relative -mt-24 bg-gray-100 sm:-mt-32">
              <div className="shimmer size-32 sm:size-52 rounded-xl ring-8 ring-gray-50 dark:bg-gray-700 dark:ring-black" />
            </div>
