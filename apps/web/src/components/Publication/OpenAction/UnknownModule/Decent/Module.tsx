...
const DecentOpenActionModule: FC<DecentOpenActionModuleProps> = ({
  ...
  const creatorProfileExists = creatorProfileData?.defaultProfile;
  ...
  const formattedTotalAmount = Number(totalAmount) / 10 ** decimals;
        ...
        <>
          ...
          <div className="space-y-5 p-5 pt-2">
            <div>
              ...
              />
              <div className="mt-4 flex items-start justify-between space-y-0.5 text-gray-600 text-xl dark:text-gray-100">
