    ...
    >
      <div className={'mt-4 flex flex-wrap gap-x-[12px] px-3 lg:px-0'}>
        ...
        <Link
          ...
          onClick={() => Mixpanel.track(MISCELLANEOUS.FOOTER.OPEN_DISCORD)}
        >
          <Trans>Discord</Trans>
        </Link>
        <Link
          ...
          target="_blank"
          rel="noreferrer noopener"
          onClick={() => Mixpanel.track(MISCELLANEOUS.FOOTER.OPEN_DONATE)}
        >
          <Trans>Donate</Trans>
        </Link>
        <Link
          ...
          target="_blank"
          rel="noreferrer noopener"
          onClick={() => Mixpanel.track(MISCELLANEOUS.FOOTER.OPEN_STATUS)}
        >
          <Trans>Status</Trans>
        </Link>
        <Link
          ...
          target="_blank"
          rel="noreferrer noopener"
          onClick={() => Mixpanel.track(MISCELLANEOUS.FOOTER.OPEN_FEEDBACK)}
        >
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer noopener"
          onClick={() => Mixpanel.track(MISCELLANEOUS.FOOTER.OPEN_GITHUB)}
        >
          <Trans>GitHub</Trans>
        </Link>
        <Link
          ...
          target="_blank"
          rel="noreferrer noopener"
          onClick={() => Mixpanel.track(MISCELLANEOUS.FOOTER.OPEN_TRANSLATE)}
        >
      ...
      <div className="mt-2 flex space-x-4">
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer noopener"
          onClick={() => Mixpanel.track(MISCELLANEOUS.FOOTER.OPEN_VERCEL)}
        >
