...
import { $createPreviewMentionNode, PreviewMentionNode } from '../Nodes/PreviewMentionsNode';
...
export function MentionsRenderPlugin(): JSX.Element | null {
  ...
  const createHashtagNode = useCallback((textNode: TextNode): any => {
  ...
  useLexicalTextEntity<PreviewMentionNode>(getHashtagMatch, PreviewMentionNode, createHashtagNode);
