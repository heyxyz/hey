import Votes from '@components/Publication/Actions/Votes';
  ...
  return (
    <Card>
      <div className="grid justify-items-left p-5 space-y-2 m-3">
        ...
        <div>
          It has received 9885 votes of 44 users in total for 10,500 DAI. It will be matched with 20000 DAI.
        </div>
        <div className="flex justify-between pt-3">
          <div>
            <Votes publication={publication} showCount={showCount} />
          </div>
