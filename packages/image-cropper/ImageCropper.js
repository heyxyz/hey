...
var ImageCropper = /** @class */ (function (_super) {
    ...
    function ImageCropper() {
        ...
        _this.preventZoomSafari = function (e) { return e.preventDefault(); };
        ...
        _this.computeSizes = function () {
            ...
            if (mediaRef && _this.containerRef) {
                var naturalWidth = ((_a = _this.imageRef.current) === null || _a === void 0 ? void 0 : _a.naturalWidth) || 0;
                var naturalHeight = ((_b = _this.imageRef.current) === null || _b === void 0 ? void 0 : _b.naturalHeight) || 0;
                var mediaAspect = naturalWidth / naturalHeight;
                var fitWidth = naturalWidth / naturalHeight <
                ...
                _this.mediaSize = __assign(__assign({}, renderedMediaSize), { naturalWidth: naturalWidth, naturalHeight: naturalHeight });
                var cropSize = {
                    width: _this.props.cropSize.width,
                    height: _this.props.cropSize.height
                };
        ...
        _this.onMouseMove = function (e) { return _this.onDrag(ImageCropper.getMousePoint(e)); };
        ...
        _this.onDragStart = function (_a) {
            ...
            _this.dragStartCrop = __assign({}, _this.getAbsolutePosition(_this.props.cropPositionPercent));
        };
        _this.onDrag = function (_a) {
            ...
            _this.rafDragTimeout = _this.currentWindow.requestAnimationFrame(function () {
                ...
                var newPosition = (0, cropUtils_1.restrictPosition)(requestedPosition, _this.mediaSize, _this.props.cropSize, _this.props.zoom);
        ...
        _this.onWheel = function (e) {
            ...
            _this.wheelTimer = _this.currentWindow.setTimeout(function () { return _this.setState({ hasWheelJustStarted: false }, function () { }); }, 250);
        };
        _this.getPointOnContainer = function (_a) {
            var _b;
            var x = _a.x, y = _a.y;
            var containerRect = (_b = _this.containerRef) === null || _b === void 0 ? void 0 : _b.getBoundingClientRect();
            if (!containerRect) {
        ...
        _this.getPointOnMedia = function (_a) {
            var x = _a.x, y = _a.y;
            var cropPosition = _this.getAbsolutePosition(_this.props.cropPositionPercent);
        ...
        _this.setNewZoom = function (zoom, point, _a) {
            ...
            var fitWidth = _this.mediaSize.width / _this.mediaSize.height <
                _this.props.cropSize.width / _this.props.cropSize.height;
            ...
            var minZoom = 1;
            var maxZoom = Math.max(minZoom, mediaToTargetSizeRatio * maxOutputBlurryness);
            ...
            if (shouldUpdatePosition) {
                ...
                var newPosition = (0, cropUtils_1.restrictPosition)(requestedPosition, _this.mediaSize, _this.props.cropSize, newZoom);
        ...
        _this.getCropData = function () {
            ...
            var cropPosition = _this.getAbsolutePosition(_this.props.cropPositionPercent);
            var restrictedPosition = (0, cropUtils_1.restrictPosition)(cropPosition, _this.mediaSize, _this.props.cropSize, _this.props.zoom);
            return (0, cropUtils_1.computeCroppedArea)(restrictedPosition, _this.props.cropSize, _this.mediaSize, _this.props.zoom);
        };
        ...
        _this.recomputeCropPosition = function () {
            var cropPosition = _this.getAbsolutePosition(_this.props.cropPositionPercent);
            var newPosition = (0, cropUtils_1.restrictPosition)(cropPosition, _this.mediaSize, _this.props.cropSize, _this.props.zoom);
            var newPercentagePosition = _this.getPercentPosition(newPosition);
            _this.props.onCropChange(newPercentagePosition);
            _this.emitCropData();
        };
    ...
    ImageCropper.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (this.props.cropSize.width !== prevProps.cropSize.width ||
    ...
    ImageCropper.prototype.onPinchStart = function (e) {
        ...
        this.lastPinchDistance = (0, cropUtils_1.getDistanceBetweenPoints)(pointA, pointB);
    ...
    ImageCropper.prototype.onPinchMove = function (e) {
        ...
        this.rafPinchTimeout = this.currentWindow.requestAnimationFrame(function () {
            var distance = (0, cropUtils_1.getDistanceBetweenPoints)(pointA, pointB);
    ...
    ImageCropper.prototype.render = function () {
        var _this = this;
        var _a = this.props, image = _a.image, size = _a.cropSize, borderSize = _a.borderSize, _b = _a.cropPositionPercent, x = _b.x, y = _b.y, zoom = _a.zoom;
        var fitWidth = this.mediaSize.naturalWidth / this.mediaSize.naturalHeight <
            this.props.cropSize.width / this.props.cropSize.height;
        return (<div className="rounded-lg" style={{
                overflow: 'hidden',
        ...
        <div className="relative" style={{ width: size.width, height: size.height }}>
          <div onMouseDown={this.onMouseDown} onTouchStart={this.onTouchStart} ref={function (el) { return (_this.containerRef = el); }} data-testid="container" className={(0, clsx_1.default)('reactEasyCrop_Container')}>
            {image && (<img alt="" className={(0, clsx_1.default)('reactEasyCrop_Image', fitWidth
                    ? 'reactEasyCrop_Cover_Horizontal'
                    : 'reactEasyCrop_Cover_Vertical')} src={image} ref={this.imageRef} style={{ transform: "translate(".concat(x, "%, ").concat(y, "%) scale(").concat(zoom, ")") }} onLoad={this.onMediaLoad}/>)}
            <div style={{
                color: '#bbba',
                boxShadow: "0 0 0 ".concat(borderSize, "px"),
                width: size.width,
                height: size.height
            }} data-testid="cropper" className={(0, clsx_1.default)('border-brand-500 border-2', 'reactEasyCrop_CropArea')}/>
          </div>
        </div>
      </div>);
    };
    ...
    ImageCropper.getMousePoint = function (e) { return ({
        x: Number(e.clientX),
        y: Number(e.clientY)
    }); };
    ImageCropper.getTouchPoint = function (touch) { return ({
