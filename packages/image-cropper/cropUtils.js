...
exports.getCroppedImg =
  exports.createImage =
  exports.getMidpoint =
  exports.computeCroppedArea =
  exports.getDistanceBetweenPoints =
  exports.restrictPosition =
  exports.restrictValue =
    void 0;
...
var computeCroppedArea = function (cropPosition, cropSize, mediaSize, zoom) {
  ...
  var croppedAreaPixels = __assign(__assign({}, cropSizePixels), {
    x:
...
var getCroppedImg = function (imageSrc, pixelCrop) {
  return __awaiter(void 0, void 0, void 0, function () {
    var image, canvas, ctx, data;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, (0, exports.createImage)(imageSrc)];
        case 1:
          image = _a.sent();
