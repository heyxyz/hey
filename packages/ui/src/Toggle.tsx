  ...
  return (
    <Switch
      ...
      className={clsx(
        ...
        'inline-flex h-[22px] w-[42.5px] min-w-[40px] cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none'
      )}
    >
      <span
        aria-hidden="true"
