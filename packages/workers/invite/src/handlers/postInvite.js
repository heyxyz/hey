...
exports.default = (function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var body, accessToken, validation, _a, address, isMainnet, mutation, inviteResponse, inviteResponseJson, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (!accessToken) {
                    return [2 /*return*/, (0, response_1.default)({ success: false, error: errors_1.Errors.NoAccessToken })];
                }
            ...
            case 2:
                ...
                return [4 /*yield*/, fetch(isMainnet ? lens_endpoints_1.default.Mainnet : lens_endpoints_1.default.Testnet, {
                        method: 'POST',
                        headers: {
            ...
            case 4:
                ...
                if (!inviteResponseJson.errors) {
                    return [2 /*return*/, (0, response_1.default)({ success: true, alreadyInvited: false })];
                }
                return [2 /*return*/, (0, response_1.default)({ success: false, alreadyInvited: true })];
            case 5:
                error_1 = _b.sent();
                throw error_1;
