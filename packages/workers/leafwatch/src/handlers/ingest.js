    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          if (
            !(0, checkEventExistence_1.default)(tracking_1.ALL_EVENTS, name)
          ) {
            return [
              2 /*return*/,
              (0, response_1.default)({
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            fetch(request.env.CLICKHOUSE_REST_ENDPOINT, {
              method: 'POST',
              ...
              body: "\n        INSERT INTO events (\n          name,\n          actor,\n          properties,\n          url,\n          city,\n          country,\n          region,\n          referrer,\n          platform,\n          browser,\n          browser_version,\n          os,\n          utm_source,\n          utm_medium,\n          utm_campaign,\n          utm_term,\n          utm_content\n        ) VALUES (\n          '"
                ...
                .concat(
                  properties
                    ? "'".concat(JSON.stringify(properties), "'")
                    : null,
                  ',\n          '
                )
                .concat(url ? "'".concat(url, "'") : null, ',\n          ')
                .concat(
                  (ipData === null || ipData === void 0 ? void 0 : ipData.city)
                    ? "'".concat(
                        ipData === null || ipData === void 0
                          ? void 0
                          : ipData.city,
                        "'"
                      )
                ...
                .concat(
                  referrer ? "'".concat(referrer, "'") : null,
                  ',\n          '
                )
                .concat(
                  platform ? "'".concat(platform, "'") : null,
                  ',\n          '
                )
                .concat(
                  ua.browser.name ? "'".concat(ua.browser.name, "'") : null,
                  ',\n          '
                )
                .concat(
                  ua.browser.version ? "'".concat(ua.os.version, "'") : null,
                  ',\n          '
                )
                .concat(
                  ua.os.name ? "'".concat(ua.os.name, "'") : null,
                  ',\n          '
                )
                .concat(
                  utmSource ? "'".concat(utmSource, "'") : null,
                  ',\n          '
                )
                .concat(
                  utmMedium ? "'".concat(utmMedium, "'") : null,
                  ',\n          '
                )
                .concat(
                  utmCampaign ? "'".concat(utmCampaign, "'") : null,
                  ',\n          '
                )
                .concat(
                  utmTerm ? "'".concat(utmTerm, "'") : null,
                  ',\n          '
                )
                .concat(
                  utmContent ? "'".concat(utmContent, "'") : null,
                  '\n        )\n      '
                )
            })
          ];
