          ...
          {({ open }) => (
            <>
              ...
              >
                <Menu.Items
                  static
                  className="absolute right-0 w-48 py-1 mt-2 origin-top-right bg-white border shadow-sm rounded-xl dark:bg-gray-900 dark:border-gray-700 focus:outline-none"
                >
                  <Menu.Item
                    as={NextLink}
