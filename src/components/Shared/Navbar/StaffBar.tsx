        ...
        {({ open }) => (
          <>
            ...
            >
              <Menu.Items
                static
                className="absolute z-10 py-1 mt-6 origin-top-right bg-white border shadow-sm right-2 rounded-xl dark:bg-gray-900 dark:border-gray-700 focus:outline-none"
              >
                <Stats />
              </Menu.Items>
            </Transition>
