...
test.describe('getIPFSLink', () => {
  ...
  test('should return ipfs gateway link when cidV0 is found', () => {
    const cidV0 = sanitizeDStorageUrl('ipfs://QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
  ...
  test('should return ipfs gateway link when cidV1 is found', () => {
    const cidV1 = sanitizeDStorageUrl('ipfs://bafkreigtnlyilggrkgpyjbgdzlxmcc4go3364n62uiq577smnnsoczfo6e');
  ...
  test('should return ipfs gateway link when doubleIpfs is found', () => {
    const doubleIpfs = sanitizeDStorageUrl('ipfs://ipfs/QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
  ...
  test('should return arweave gateway link when arweave hash is found', () => {
    const arweave = sanitizeDStorageUrl('ar://Xa6qk95912lq3uWMi0V6wxBYQer99q0i7_6iSt1SmHA');

    expect(arweave).toBe('https://arweave.net/Xa6qk95912lq3uWMi0V6wxBYQer99q0i7_6iSt1SmHA');
  });

  test('should return arweave gateway link when arweave link is found', () => {
    const arweave = sanitizeDStorageUrl('https://arweave.net/Xa6qk95912lq3uWMi0V6wxBYQer99q0i7_6iSt1SmHA');
